...
p1 = -4.65421 + (4.65421*i) %-1 + 2*pi*i    % dominant pole pair
p2 = -4.65421 - (4.65421*i) %-1 - 2*pi*i    % dominant pole pair 
p3 = -.5
p4 = -.5   % dominant pole pair
p5 = -20     % dominant pole pair 

% p1 = -2 + (3*i) %-1 + 2*pi*i    % dominant pole pair
% p2 = -2 - (3*i) %-1 - 2*pi*i    % dominant pole pair 
% p3 = -3
% p4 = -2   % dominant pole pair
