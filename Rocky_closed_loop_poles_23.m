...
% system parameters
g = 9.81;
l = .4524; %22*2.54/100   %effective length 
a = 19.5; %14;           %nominal motor parameters
b = 1/338.6; %1/400;        %nominal motor parameters
...
p1 = -7 + (18.35*i) %-1 + 2*pi*i    % dominant pole pair
p2 = -7 - (18.35*i) %-1 - 2*pi*i    % dominant pole pair 
p3 = -5.5
